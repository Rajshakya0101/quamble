          ...
          isLogin ? <>
            <div className='form'>
              ...
              <div className='social-login'>
                <button className='google-btn'><i className="fab fa-google"></i>Login with </button>
                <br />
                <button className='facebook-btn'><i className='fab fa-facebook-f'></i>Login with </button>
              </div><br />
